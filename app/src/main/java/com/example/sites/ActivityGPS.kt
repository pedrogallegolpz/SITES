        ...
        if (googleMap != null) {
            ...
            for(i in m.arraySitios.indices){
                somewhere = googleMap.addMarker(
                    ...
                    ).title(m.arrayNombres[i]).snippet(m.info[i]+"\nToca esta ventana para saber como ir al mirador").icon(
                ...
                googleMap.setOnInfoWindowClickListener(object :
                    ...
                    override fun onInfoWindowClick(marker: Marker) {
                        if(marker.title.equals(m.arrayNombres[1]))
                            Toast.makeText(this@ActivityGPS,"Torre Vela", Toast.LENGTH_SHORT).show()
